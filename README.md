...
| 2026-08-05 | [Five More Paper Sleeves: InvestSim Tier-2.5 Without a New Signal Feed](posts/2026-08-05-investsim-tier25-paper-sleeves.md) · [中文](posts/2026-08-05-investsim-tier25-paper-sleeves.zh.md) | InvestSim | `investsim` `paper-trading` `strategy` `adr` `invest-ai` |
| 2026-08-05 | [Evidence Before Draft: Robinhood MCP Now Reads InvestSim](posts/2026-08-05-robinhood-mcp-investsim-evidence-handoff.md) · [中文](posts/2026-08-05-robinhood-mcp-investsim-evidence-handoff.zh.md) | Robinhood MCP | `mcp` `robinhood` `investsim` `execution-gates` `human-in-the-loop` `adr` |
| 2026-08-04 | [每日投资智报: Extend Invest AI, Do Not Spin Another Report Product](posts/2026-08-04-invest-ai-daily-investment-zhibao-pdf.md) · [中文](posts/2026-08-04-invest-ai-daily-investment-zhibao-pdf.zh.md) | Invest AI | `invest-ai` `pdf` `resend` `worker` `reporting` `adr` `yfinance` |
| 2026-08-04 | [Three Honesty Fixes After Citation Verification Shipped](posts/2026-08-04-evidence-honesty-overlay-pdf-refs-citation-dates.md) · [中文](posts/2026-08-04-evidence-honesty-overlay-pdf-refs-citation-dates.zh.md) | Evidence Engine | `evidence` `citation-verification` `pdf` `human-in-the-loop` `adr` `provenance` |
| 2026-08-04 | [XNP Phase 2: A Modular Monolith That Boots With Nothing In It](posts/2026-08-04-xnp-phase-2-foundation-modular-monolith.md) · [中文](posts/2026-08-04-xnp-phase-2-foundation-modular-monolith.zh.md) | Notification Platform | `xnp` `dotnet` `postgres` `outbox` `multi-tenancy` `architecture` `adr` |
| 2026-08-04 | [Human Overlay Cache: Review Writes That Survive Re-Verify](posts/2026-08-04-human-overlay-cache-pattern.md) · [中文](posts/2026-08-04-human-overlay-cache-pattern.zh.md) | Engineering System + Evidence Engine | `patterns` `worker-cache` `human-in-the-loop` `evidence` `decision-boundary` |
| 2026-07-26 | [We Ran Our Own AI Radar Through Citation Verification. It Flagged Us.](posts/2026-07-26-we-verified-our-own-radar.md) · [中文](posts/2026-07-26-we-verified-our-own-radar.zh.md) | Evidence Engine + Opportunity Radar | `evidence` `citation-verification` `evaluation` `every-eval-ever` `dogfooding` |
