...
**语言：** [English ↑](#rules-first-ai-second-t-todays-two-layer-decision-engine) · 中文
...
- [访客开放首页](./2026-05-30-t-today-guest-access-and-ai-quotas.md) — 谁可以不登录调用引擎  
- [双语 JSON 复盘](./2026-05-30-t-today-bilingual-advisory-json.md) — AI 输出形状  
- [三层 AI 架构](./2026-05-12-three-layer-ai-architecture.md) — 旗舰 Invest AI 模式  
