...
![MCP 架构图：四种连接模式与鉴权流程](../assets/MCP-Architecture-Best-Practices.png)
...
**架构图：** [PNG](../assets/MCP-Architecture-Best-Practices.png) · [SVG 源文件](../assets/MCP-Architecture-Best-Practices.svg)
